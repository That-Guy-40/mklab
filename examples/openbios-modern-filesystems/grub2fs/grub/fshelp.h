/* grub/fshelp.h — minimal grub2fs shim: declarations for the shared directory
 * walk / block-map reader that the vendored fshelp.c implements. Declarations
 * copied verbatim from GRUB 2.12 so the drivers and fshelp.c agree. */
#ifndef GRUB2FS_GRUB_FSHELP_HEADER
#define GRUB2FS_GRUB_FSHELP_HEADER 1
...
#endif /* ! GRUB2FS_GRUB_FSHELP_HEADER */
