#!/usr/bin/env bash
# Shared helpers for the almalinux-packer-images tests.
# Copied VERBATIM from examples/zfsbootmenu-boot-environments/tests/lib.sh (itself a
# copy of phase2-qemu-vm's) — a fourth hand-written net would be a fourth thing to
# drift, which is TODO 15.2's finding about this very directory.
