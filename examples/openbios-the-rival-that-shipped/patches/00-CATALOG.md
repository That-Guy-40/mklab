...
| scope | count | |
|---|---|---|
| shared | 26 | touches a path some *other* architecture's build also compiles — this is where a pin bump conflicts |
...
The other 46 are things upstream would arguably want and is not going to be
